# Comparing `tmp/OctoBot-Commons-1.9.3.tar.gz` & `tmp/OctoBot-Commons-1.9.4.tar.gz`
...
### Comparing `OctoBot-Commons-1.9.3/octobot_commons/aiohttp_util.py` & `OctoBot-Commons-1.9.4/octobot_commons/aiohttp_util.py`
...
### Comparing `OctoBot-Commons-1.9.3/octobot_commons/databases/document_database_adaptors/abstract_document_database_adaptor.py` & `OctoBot-Commons-1.9.4/octobot_commons/databases/document_database_adaptors/abstract_document_database_adaptor.py`
...
### Comparing `OctoBot-Commons-1.9.3/octobot_commons/external_resources_manager.py` & `OctoBot-Commons-1.9.4/octobot_commons/external_resources_manager.py`
...
### Comparing `OctoBot-Commons-1.9.3/octobot_commons/signals/signal.py` & `OctoBot-Commons-1.9.4/octobot_commons/signals/signal.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/octobot_commons/signals/signal_builder_wrapper.py` & `OctoBot-Commons-1.9.4/octobot_commons/signals/signal_builder_wrapper.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/octobot_commons/signals/signal_bundle.py` & `OctoBot-Commons-1.9.4/octobot_commons/signals/signal_bundle.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/octobot_commons/signals/signal_bundle_builder.py` & `OctoBot-Commons-1.9.4/octobot_commons/signals/signal_bundle_builder.py`
...
### Comparing `OctoBot-Commons-1.9.3/octobot_commons/signals/signal_factory.py` & `OctoBot-Commons-1.9.4/octobot_commons/signals/signal_factory.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/octobot_commons/signals/signal_publisher.py` & `OctoBot-Commons-1.9.4/octobot_commons/signals/signal_publisher.py`
...
### Comparing `OctoBot-Commons-1.9.3/octobot_commons/signals/signals_emitter.py` & `OctoBot-Commons-1.9.4/octobot_commons/signals/signals_emitter.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/octobot_commons/singleton/__init__.py` & `OctoBot-Commons-1.9.4/octobot_commons/singleton/__init__.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/octobot_commons/singleton/singleton_class.py` & `OctoBot-Commons-1.9.4/octobot_commons/singleton/singleton_class.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/octobot_commons/support.py` & `OctoBot-Commons-1.9.4/octobot_commons/support.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/octobot_commons/symbols/__init__.py` & `OctoBot-Commons-1.9.4/octobot_commons/symbols/__init__.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/octobot_commons/symbols/symbol.py` & `OctoBot-Commons-1.9.4/octobot_commons/symbols/symbol.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/octobot_commons/symbols/symbol_util.py` & `OctoBot-Commons-1.9.4/octobot_commons/symbols/symbol_util.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/octobot_commons/system_resources_watcher.py` & `OctoBot-Commons-1.9.4/octobot_commons/system_resources_watcher.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/octobot_commons/tentacles_management/__init__.py` & `OctoBot-Commons-1.9.4/octobot_commons/tentacles_management/__init__.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/octobot_commons/tentacles_management/abstract_tentacle.py` & `OctoBot-Commons-1.9.4/octobot_commons/tentacles_management/abstract_tentacle.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/octobot_commons/tentacles_management/class_inspector.py` & `OctoBot-Commons-1.9.4/octobot_commons/tentacles_management/class_inspector.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/octobot_commons/tests/__init__.py` & `OctoBot-Commons-1.9.4/octobot_commons/tests/__init__.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/octobot_commons/tests/test_config.py` & `OctoBot-Commons-1.9.4/octobot_commons/tests/test_config.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/octobot_commons/thread_util.py` & `OctoBot-Commons-1.9.4/octobot_commons/thread_util.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/octobot_commons/time_frame_manager.py` & `OctoBot-Commons-1.9.4/octobot_commons/time_frame_manager.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/octobot_commons/timestamp_util.py` & `OctoBot-Commons-1.9.4/octobot_commons/timestamp_util.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/octobot_commons/tree/__init__.py` & `OctoBot-Commons-1.9.4/octobot_commons/tree/__init__.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/octobot_commons/tree/base_tree.py` & `OctoBot-Commons-1.9.4/octobot_commons/tree/base_tree.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/octobot_commons/tree/event_provider.py` & `OctoBot-Commons-1.9.4/octobot_commons/tree/event_provider.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/octobot_commons/tree/event_tree.py` & `OctoBot-Commons-1.9.4/octobot_commons/tree/event_tree.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/setup.py` & `OctoBot-Commons-1.9.4/setup.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/tests/configuration/__init__.py` & `OctoBot-Commons-1.9.4/tests/configuration/__init__.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/tests/configuration/test_configuration.py` & `OctoBot-Commons-1.9.4/tests/configuration/test_configuration.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/tests/configuration/test_fields_util.py` & `OctoBot-Commons-1.9.4/tests/configuration/test_fields_util.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/tests/databases/global_storage/test_global_shared_memory_storage.py` & `OctoBot-Commons-1.9.4/tests/databases/global_storage/test_global_shared_memory_storage.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/tests/databases/relational_databases/sqlite/test_sqlite_database.py` & `OctoBot-Commons-1.9.4/tests/databases/relational_databases/sqlite/test_sqlite_database.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/tests/databases/run_databases/test_run_databases_provider.py` & `OctoBot-Commons-1.9.4/tests/databases/run_databases/test_run_databases_provider.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/tests/logging/test_logging_util.py` & `OctoBot-Commons-1.9.4/tests/logging/test_logging_util.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/tests/profiles/__init__.py` & `OctoBot-Commons-1.9.4/tests/profiles/__init__.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/tests/profiles/test_profile.py` & `OctoBot-Commons-1.9.4/tests/profiles/test_profile.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/tests/profiles/test_profile_sharing.py` & `OctoBot-Commons-1.9.4/tests/profiles/test_profile_sharing.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/tests/signals/__init__.py` & `OctoBot-Commons-1.9.4/tests/signals/__init__.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/tests/signals/test_signal.py` & `OctoBot-Commons-1.9.4/tests/signals/test_signal.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/tests/signals/test_signal_builder_wrapper.py` & `OctoBot-Commons-1.9.4/tests/signals/test_signal_builder_wrapper.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/tests/signals/test_signal_bundle.py` & `OctoBot-Commons-1.9.4/tests/signals/test_signal_bundle.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/tests/signals/test_signal_bundle_builder.py` & `OctoBot-Commons-1.9.4/tests/signals/test_signal_bundle_builder.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/tests/signals/test_signal_factory.py` & `OctoBot-Commons-1.9.4/tests/signals/test_signal_factory.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/tests/signals/test_signal_publisher.py` & `OctoBot-Commons-1.9.4/tests/signals/test_signal_publisher.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/tests/symbols/test_symbol.py` & `OctoBot-Commons-1.9.4/tests/symbols/test_symbol.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/tests/symbols/test_symbol_util.py` & `OctoBot-Commons-1.9.4/tests/symbols/test_symbol_util.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/tests/tentacles_management/test_abstract_tentacle.py` & `OctoBot-Commons-1.9.4/tests/tentacles_management/test_abstract_tentacle.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/tests/tentacles_management/test_class_inspector.py` & `OctoBot-Commons-1.9.4/tests/tentacles_management/test_class_inspector.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/tests/tree/test_base_tree.py` & `OctoBot-Commons-1.9.4/tests/tree/test_base_tree.py`

 * *Files identical despite different names*

### Comparing `OctoBot-Commons-1.9.3/tests/tree/test_event_tree.py` & `OctoBot-Commons-1.9.4/tests/tree/test_event_tree.py`
