# Comparing `tmp/ambient-toolbox-8.2.1.tar.gz` & `tmp/ambient-toolbox-8.3.0.tar.gz`
...
### Comparing `ambient-toolbox-8.2.1/Dockerfile` & `ambient-toolbox-8.3.0/Dockerfile`
...
### Comparing `ambient-toolbox-8.2.1/ambient_toolbox/templatetags/ai_email_tags.py` & `ambient-toolbox-8.3.0/ambient_toolbox/templatetags/ai_email_tags.py`
...
### Comparing `ambient-toolbox-8.2.1/docs/make.bat` & `ambient-toolbox-8.3.0/docs/make.bat`
...
### Comparing `ambient-toolbox-8.2.1/tests/query_selectors/test_permission.py` & `ambient-toolbox-8.3.0/tests/query_selectors/test_permission.py`
...
### Comparing `ambient-toolbox-8.2.1/tests/test_math.py` & `ambient-toolbox-8.3.0/tests/test_math.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.2.1/tests/test_middleware.py` & `ambient-toolbox-8.3.0/tests/test_middleware.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.2.1/tests/test_mixins_models.py` & `ambient-toolbox-8.3.0/tests/test_mixins_models.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.2.1/tests/test_models.py` & `ambient-toolbox-8.3.0/tests/test_models.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.2.1/tests/test_rest_api_mixins.py` & `ambient-toolbox-8.3.0/tests/test_rest_api_mixins.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.2.1/tests/test_scrubbing_service.py` & `ambient-toolbox-8.3.0/tests/test_scrubbing_service.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.2.1/tests/test_utils_date.py` & `ambient-toolbox-8.3.0/tests/test_utils_date.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.2.1/tests/test_utils_file.py` & `ambient-toolbox-8.3.0/tests/test_utils_file.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.2.1/tests/test_utils_model.py` & `ambient-toolbox-8.3.0/tests/test_utils_model.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.2.1/tests/test_utils_named_tuple.py` & `ambient-toolbox-8.3.0/tests/test_utils_named_tuple.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.2.1/tests/test_utils_string.py` & `ambient-toolbox-8.3.0/tests/test_utils_string.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.2.1/tests/tests/mixins/test_django_message_framework.py` & `ambient-toolbox-8.3.0/tests/tests/mixins/test_django_message_framework.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.2.1/tests/tests/mixins/test_request_provider_mixin.py` & `ambient-toolbox-8.3.0/tests/tests/mixins/test_request_provider_mixin.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.2.1/tests/tests/test_mail_backends.py` & `ambient-toolbox-8.3.0/tests/tests/test_mail_backends.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.2.1/tests/view_layer/test_formset_mixins.py` & `ambient-toolbox-8.3.0/tests/view_layer/test_formset_mixins.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.2.1/tests/view_layer/test_htmx_response_mixin.py` & `ambient-toolbox-8.3.0/tests/view_layer/test_htmx_response_mixin.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.2.1/tests/view_layer/test_meta_mixins.py` & `ambient-toolbox-8.3.0/tests/view_layer/test_meta_mixins.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.2.1/tests/view_layer/test_views.py` & `ambient-toolbox-8.3.0/tests/view_layer/test_views.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.2.1/PKG-INFO` & `ambient-toolbox-8.3.0/PKG-INFO`
