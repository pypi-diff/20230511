# Comparing `tmp/vantage6-client-3.8.7rc1.tar.gz` & `tmp/vantage6-client-3.9.0rc2.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "vantage6-client-3.8.7rc1.tar", last modified: Tue May  9 13:12:26 2023, max compression
+gzip compressed data, was "vantage6-client-3.9.0rc2.tar", last modified: Tue May  9 13:37:04 2023, max compression
```

## Comparing `vantage6-client-3.8.7rc1.tar` & `vantage6-client-3.9.0rc2.tar`

### file list

```diff
@@ -1,38 +1,38 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-09 13:12:26.510976 vantage6-client-3.8.7rc1/
--rw-r--r--   0 runner    (1001) docker     (123)     5068 2023-05-09 13:12:26.510976 vantage6-client-3.8.7rc1/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)       38 2023-05-09 13:12:26.510976 vantage6-client-3.8.7rc1/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (123)     1503 2023-05-09 13:12:08.000000 vantage6-client-3.8.7rc1/setup.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-09 13:12:26.510976 vantage6-client-3.8.7rc1/tests/
--rw-r--r--   0 runner    (1001) docker     (123)       79 2023-05-09 13:12:08.000000 vantage6-client-3.8.7rc1/tests/algorithm_module.py
--rw-r--r--   0 runner    (1001) docker     (123)     4426 2023-05-09 13:12:08.000000 vantage6-client-3.8.7rc1/tests/test_client.py
--rw-r--r--   0 runner    (1001) docker     (123)      806 2023-05-09 13:12:08.000000 vantage6-client-3.8.7rc1/tests/test_deserialization.py
--rw-r--r--   0 runner    (1001) docker     (123)     5987 2023-05-09 13:12:08.000000 vantage6-client-3.8.7rc1/tests/test_docker_wrapper.py
--rw-r--r--   0 runner    (1001) docker     (123)     1108 2023-05-09 13:12:08.000000 vantage6-client-3.8.7rc1/tests/test_serialization.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-09 13:12:26.506976 vantage6-client-3.8.7rc1/vantage6/
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-09 13:12:26.510976 vantage6-client-3.8.7rc1/vantage6/client/
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-05-09 13:12:08.000000 vantage6-client-3.8.7rc1/vantage6/client/__build__
--rw-r--r--   0 runner    (1001) docker     (123)    81359 2023-05-09 13:12:08.000000 vantage6-client-3.8.7rc1/vantage6/client/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)      697 2023-05-09 13:12:08.000000 vantage6-client-3.8.7rc1/vantage6/client/_version.py
--rw-r--r--   0 runner    (1001) docker     (123)    11220 2023-05-09 13:12:08.000000 vantage6-client-3.8.7rc1/vantage6/client/algorithm_client.py
--rw-r--r--   0 runner    (1001) docker     (123)     3190 2023-05-09 13:12:08.000000 vantage6-client-3.8.7rc1/vantage6/client/deserialization.py
--rw-r--r--   0 runner    (1001) docker     (123)       52 2023-05-09 13:12:08.000000 vantage6-client-3.8.7rc1/vantage6/client/exceptions.py
--rw-r--r--   0 runner    (1001) docker     (123)     3389 2023-05-09 13:12:08.000000 vantage6-client-3.8.7rc1/vantage6/client/filter.py
--rw-r--r--   0 runner    (1001) docker     (123)     1179 2023-05-09 13:12:08.000000 vantage6-client-3.8.7rc1/vantage6/client/serialization.py
--rw-r--r--   0 runner    (1001) docker     (123)     1528 2023-05-09 13:12:08.000000 vantage6-client-3.8.7rc1/vantage6/client/utils.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-09 13:12:26.510976 vantage6-client-3.8.7rc1/vantage6/tools/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-05-09 13:12:08.000000 vantage6-client-3.8.7rc1/vantage6/tools/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)      397 2023-05-09 13:12:08.000000 vantage6-client-3.8.7rc1/vantage6/tools/data_format.py
--rw-r--r--   0 runner    (1001) docker     (123)     1313 2023-05-09 13:12:08.000000 vantage6-client-3.8.7rc1/vantage6/tools/deserialization.py
--rw-r--r--   0 runner    (1001) docker     (123)     2433 2023-05-09 13:12:08.000000 vantage6-client-3.8.7rc1/vantage6/tools/dispatch_rpc.py
--rw-r--r--   0 runner    (1001) docker     (123)      201 2023-05-09 13:12:08.000000 vantage6-client-3.8.7rc1/vantage6/tools/docker_wrapper.py
--rw-r--r--   0 runner    (1001) docker     (123)       52 2023-05-09 13:12:08.000000 vantage6-client-3.8.7rc1/vantage6/tools/exceptions.py
--rw-r--r--   0 runner    (1001) docker     (123)     2169 2023-05-09 13:12:08.000000 vantage6-client-3.8.7rc1/vantage6/tools/mock_client.py
--rw-r--r--   0 runner    (1001) docker     (123)     1851 2023-05-09 13:12:08.000000 vantage6-client-3.8.7rc1/vantage6/tools/serialization.py
--rw-r--r--   0 runner    (1001) docker     (123)      624 2023-05-09 13:12:08.000000 vantage6-client-3.8.7rc1/vantage6/tools/util.py
--rw-r--r--   0 runner    (1001) docker     (123)    18458 2023-05-09 13:12:08.000000 vantage6-client-3.8.7rc1/vantage6/tools/wrapper.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-09 13:12:26.510976 vantage6-client-3.8.7rc1/vantage6_client.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)     5068 2023-05-09 13:12:26.000000 vantage6-client-3.8.7rc1/vantage6_client.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      898 2023-05-09 13:12:26.000000 vantage6-client-3.8.7rc1/vantage6_client.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-05-09 13:12:26.000000 vantage6-client-3.8.7rc1/vantage6_client.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)      126 2023-05-09 13:12:26.000000 vantage6-client-3.8.7rc1/vantage6_client.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)       15 2023-05-09 13:12:26.000000 vantage6-client-3.8.7rc1/vantage6_client.egg-info/top_level.txt
...
### Comparing `vantage6-client-3.8.7rc1/PKG-INFO` & `vantage6-client-3.9.0rc2/PKG-INFO`
...
```diff
@@ -1,8 +1,8 @@
-Metadata-Version: 2.1 Name: vantage6-client Version: 3.8.7rc1 Summary: Vantage6
...
### Comparing `vantage6-client-3.8.7rc1/setup.py` & `vantage6-client-3.9.0rc2/setup.py`

 * *Files identical despite different names*

### Comparing `vantage6-client-3.8.7rc1/tests/test_client.py` & `vantage6-client-3.9.0rc2/tests/test_client.py`
...
### Comparing `vantage6-client-3.8.7rc1/tests/test_deserialization.py` & `vantage6-client-3.9.0rc2/tests/test_deserialization.py`

 * *Files identical despite different names*

### Comparing `vantage6-client-3.8.7rc1/tests/test_docker_wrapper.py` & `vantage6-client-3.9.0rc2/tests/test_docker_wrapper.py`

 * *Files identical despite different names*

### Comparing `vantage6-client-3.8.7rc1/tests/test_serialization.py` & `vantage6-client-3.9.0rc2/tests/test_serialization.py`

 * *Files identical despite different names*

### Comparing `vantage6-client-3.8.7rc1/vantage6/client/__init__.py` & `vantage6-client-3.9.0rc2/vantage6/client/__init__.py`
...
### Comparing `vantage6-client-3.8.7rc1/vantage6/client/_version.py` & `vantage6-client-3.9.0rc2/vantage6/client/_version.py`
...
### Comparing `vantage6-client-3.8.7rc1/vantage6/client/algorithm_client.py` & `vantage6-client-3.9.0rc2/vantage6/client/algorithm_client.py`
...
### Comparing `vantage6-client-3.8.7rc1/vantage6/client/deserialization.py` & `vantage6-client-3.9.0rc2/vantage6/client/deserialization.py`

 * *Files identical despite different names*

### Comparing `vantage6-client-3.8.7rc1/vantage6/client/serialization.py` & `vantage6-client-3.9.0rc2/vantage6/client/serialization.py`

 * *Files identical despite different names*

### Comparing `vantage6-client-3.8.7rc1/vantage6/client/utils.py` & `vantage6-client-3.9.0rc2/vantage6/client/utils.py`
...
### Comparing `vantage6-client-3.8.7rc1/vantage6/tools/deserialization.py` & `vantage6-client-3.9.0rc2/vantage6/tools/deserialization.py`

 * *Files identical despite different names*

### Comparing `vantage6-client-3.8.7rc1/vantage6/tools/serialization.py` & `vantage6-client-3.9.0rc2/vantage6/tools/serialization.py`

 * *Files identical despite different names*

### Comparing `vantage6-client-3.8.7rc1/vantage6/tools/util.py` & `vantage6-client-3.9.0rc2/vantage6/tools/util.py`

 * *Files identical despite different names*

### Comparing `vantage6-client-3.8.7rc1/vantage6/tools/wrapper.py` & `vantage6-client-3.9.0rc2/vantage6/tools/wrapper.py`
...
### Comparing `vantage6-client-3.8.7rc1/vantage6_client.egg-info/PKG-INFO` & `vantage6-client-3.9.0rc2/vantage6_client.egg-info/PKG-INFO`
...
### Comparing `vantage6-client-3.8.7rc1/vantage6_client.egg-info/SOURCES.txt` & `vantage6-client-3.9.0rc2/vantage6_client.egg-info/SOURCES.txt`
