# Comparing `tmp/vantage6-common-3.8.7rc1.tar.gz` & `tmp/vantage6-common-3.9.0rc2.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "vantage6-common-3.8.7rc1.tar", last modified: Tue May  9 13:12:25 2023, max compression
+gzip compressed data, was "vantage6-common-3.9.0rc2.tar", last modified: Tue May  9 13:37:04 2023, max compression
```

## Comparing `vantage6-common-3.8.7rc1.tar` & `vantage6-common-3.9.0rc2.tar`

### file list

```diff
@@ -1,27 +1,28 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-09 13:12:25.730941 vantage6-common-3.8.7rc1/
--rw-r--r--   0 runner    (1001) docker     (123)     5068 2023-05-09 13:12:25.730941 vantage6-common-3.8.7rc1/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)       38 2023-05-09 13:12:25.730941 vantage6-common-3.8.7rc1/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (123)     1434 2023-05-09 13:12:08.000000 vantage6-common-3.8.7rc1/setup.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-09 13:12:25.726941 vantage6-common-3.8.7rc1/vantage6/
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-09 13:12:25.730941 vantage6-common-3.8.7rc1/vantage6/common/
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-05-09 13:12:08.000000 vantage6-common-3.8.7rc1/vantage6/common/__build__
--rw-r--r--   0 runner    (1001) docker     (123)     4571 2023-05-09 13:12:08.000000 vantage6-common-3.8.7rc1/vantage6/common/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)      696 2023-05-09 13:12:08.000000 vantage6-common-3.8.7rc1/vantage6/common/_version.py
--rw-r--r--   0 runner    (1001) docker     (123)     5450 2023-05-09 13:12:08.000000 vantage6-common-3.8.7rc1/vantage6/common/colors.py
--rw-r--r--   0 runner    (1001) docker     (123)     4048 2023-05-09 13:12:08.000000 vantage6-common-3.8.7rc1/vantage6/common/configuration_manager.py
--rw-r--r--   0 runner    (1001) docker     (123)    12246 2023-05-09 13:12:08.000000 vantage6-common-3.8.7rc1/vantage6/common/context.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-09 13:12:25.730941 vantage6-common-3.8.7rc1/vantage6/common/docker/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-05-09 13:12:08.000000 vantage6-common-3.8.7rc1/vantage6/common/docker/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)    13566 2023-05-09 13:12:08.000000 vantage6-common-3.8.7rc1/vantage6/common/docker/addons.py
--rw-r--r--   0 runner    (1001) docker     (123)     5316 2023-05-09 13:12:08.000000 vantage6-common-3.8.7rc1/vantage6/common/docker/network_manager.py
--rw-r--r--   0 runner    (1001) docker     (123)     7994 2023-05-09 13:12:08.000000 vantage6-common-3.8.7rc1/vantage6/common/encryption.py
--rw-r--r--   0 runner    (1001) docker     (123)      112 2023-05-09 13:12:08.000000 vantage6-common-3.8.7rc1/vantage6/common/exceptions.py
--rw-r--r--   0 runner    (1001) docker     (123)      578 2023-05-09 13:12:08.000000 vantage6-common-3.8.7rc1/vantage6/common/globals.py
--rw-r--r--   0 runner    (1001) docker     (123)     1656 2023-05-09 13:12:08.000000 vantage6-common-3.8.7rc1/vantage6/common/task_status.py
--rw-r--r--   0 runner    (1001) docker     (123)     4313 2023-05-09 13:12:08.000000 vantage6-common-3.8.7rc1/vantage6/common/utest.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-09 13:12:25.730941 vantage6-common-3.8.7rc1/vantage6_common.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)     5068 2023-05-09 13:12:25.000000 vantage6-common-3.8.7rc1/vantage6_common.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      631 2023-05-09 13:12:25.000000 vantage6-common-3.8.7rc1/vantage6_common.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-05-09 13:12:25.000000 vantage6-common-3.8.7rc1/vantage6_common.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)      148 2023-05-09 13:12:25.000000 vantage6-common-3.8.7rc1/vantage6_common.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)        9 2023-05-09 13:12:25.000000 vantage6-common-3.8.7rc1/vantage6_common.egg-info/top_level.txt
...
### Comparing `vantage6-common-3.8.7rc1/PKG-INFO` & `vantage6-common-3.9.0rc2/PKG-INFO`
...
```diff
@@ -1,8 +1,8 @@
-Metadata-Version: 2.1 Name: vantage6-common Version: 3.8.7rc1 Summary: Vantage6
...
### Comparing `vantage6-common-3.8.7rc1/setup.py` & `vantage6-common-3.9.0rc2/setup.py`

 * *Files identical despite different names*

### Comparing `vantage6-common-3.8.7rc1/vantage6/common/_version.py` & `vantage6-common-3.9.0rc2/vantage6/common/_version.py`
...
### Comparing `vantage6-common-3.8.7rc1/vantage6/common/docker/addons.py` & `vantage6-common-3.9.0rc2/vantage6/common/docker/addons.py`
...
### Comparing `vantage6-common-3.8.7rc1/vantage6/common/docker/network_manager.py` & `vantage6-common-3.9.0rc2/vantage6/common/docker/network_manager.py`
...
### Comparing `vantage6-common-3.8.7rc1/vantage6/common/encryption.py` & `vantage6-common-3.9.0rc2/vantage6/common/encryption.py`
...
### Comparing `vantage6-common-3.8.7rc1/vantage6/common/globals.py` & `vantage6-common-3.9.0rc2/vantage6/common/globals.py`

 * *Files identical despite different names*

### Comparing `vantage6-common-3.8.7rc1/vantage6/common/task_status.py` & `vantage6-common-3.9.0rc2/vantage6/common/task_status.py`
...
### Comparing `vantage6-common-3.8.7rc1/vantage6/common/utest.py` & `vantage6-common-3.9.0rc2/vantage6/common/utest.py`
...
### Comparing `vantage6-common-3.8.7rc1/vantage6_common.egg-info/PKG-INFO` & `vantage6-common-3.9.0rc2/vantage6_common.egg-info/PKG-INFO`
...
### Comparing `vantage6-common-3.8.7rc1/vantage6_common.egg-info/SOURCES.txt` & `vantage6-common-3.9.0rc2/vantage6_common.egg-info/SOURCES.txt`
