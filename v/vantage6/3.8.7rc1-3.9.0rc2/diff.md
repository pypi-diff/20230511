# Comparing `tmp/vantage6-3.8.7rc1.tar.gz` & `tmp/vantage6-3.9.0rc2.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "vantage6-3.8.7rc1.tar", last modified: Tue May  9 13:12:26 2023, max compression
+gzip compressed data, was "vantage6-3.9.0rc2.tar", last modified: Tue May  9 13:37:05 2023, max compression
```

## Comparing `vantage6-3.8.7rc1.tar` & `vantage6-3.9.0rc2.tar`

### file list

```diff
@@ -1,34 +1,34 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-09 13:12:26.966997 vantage6-3.8.7rc1/
--rw-r--r--   0 runner    (1001) docker     (123)     5097 2023-05-09 13:12:26.966997 vantage6-3.8.7rc1/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)       38 2023-05-09 13:12:26.966997 vantage6-3.8.7rc1/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (123)     1806 2023-05-09 13:12:08.000000 vantage6-3.8.7rc1/setup.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-09 13:12:26.962997 vantage6-3.8.7rc1/tests_cli/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-05-09 13:12:08.000000 vantage6-3.8.7rc1/tests_cli/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)      147 2023-05-09 13:12:08.000000 vantage6-3.8.7rc1/tests_cli/test_example.py
--rw-r--r--   0 runner    (1001) docker     (123)    14852 2023-05-09 13:12:08.000000 vantage6-3.8.7rc1/tests_cli/test_node_cli.py
--rw-r--r--   0 runner    (1001) docker     (123)     5895 2023-05-09 13:12:08.000000 vantage6-3.8.7rc1/tests_cli/test_server_cli.py
--rw-r--r--   0 runner    (1001) docker     (123)     3401 2023-05-09 13:12:08.000000 vantage6-3.8.7rc1/tests_cli/test_wizard.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-09 13:12:26.958997 vantage6-3.8.7rc1/vantage6/
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-09 13:12:26.966997 vantage6-3.8.7rc1/vantage6/cli/
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-05-09 13:12:08.000000 vantage6-3.8.7rc1/vantage6/cli/__build__
--rw-r--r--   0 runner    (1001) docker     (123)       62 2023-05-09 13:12:08.000000 vantage6-3.8.7rc1/vantage6/cli/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)      695 2023-05-09 13:12:08.000000 vantage6-3.8.7rc1/vantage6/cli/_version.py
--rw-r--r--   0 runner    (1001) docker     (123)     2273 2023-05-09 13:12:08.000000 vantage6-3.8.7rc1/vantage6/cli/configuration_manager.py
--rw-r--r--   0 runner    (1001) docker     (123)     8488 2023-05-09 13:12:08.000000 vantage6-3.8.7rc1/vantage6/cli/configuration_wizard.py
--rw-r--r--   0 runner    (1001) docker     (123)    13629 2023-05-09 13:12:08.000000 vantage6-3.8.7rc1/vantage6/cli/context.py
--rw-r--r--   0 runner    (1001) docker     (123)      800 2023-05-09 13:12:08.000000 vantage6-3.8.7rc1/vantage6/cli/globals.py
--rw-r--r--   0 runner    (1001) docker     (123)    37306 2023-05-09 13:12:08.000000 vantage6-3.8.7rc1/vantage6/cli/node.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-09 13:12:26.966997 vantage6-3.8.7rc1/vantage6/cli/rabbitmq/
--rw-r--r--   0 runner    (1001) docker     (123)     1279 2023-05-09 13:12:08.000000 vantage6-3.8.7rc1/vantage6/cli/rabbitmq/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)      536 2023-05-09 13:12:08.000000 vantage6-3.8.7rc1/vantage6/cli/rabbitmq/definitions.py
--rw-r--r--   0 runner    (1001) docker     (123)     7523 2023-05-09 13:12:08.000000 vantage6-3.8.7rc1/vantage6/cli/rabbitmq/queue_manager.py
--rw-r--r--   0 runner    (1001) docker     (123)      136 2023-05-09 13:12:08.000000 vantage6-3.8.7rc1/vantage6/cli/rabbitmq/rabbitmq.config
--rw-r--r--   0 runner    (1001) docker     (123)    29692 2023-05-09 13:12:08.000000 vantage6-3.8.7rc1/vantage6/cli/server.py
--rw-r--r--   0 runner    (1001) docker     (123)     1059 2023-05-09 13:12:08.000000 vantage6-3.8.7rc1/vantage6/cli/utils.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-09 13:12:26.962997 vantage6-3.8.7rc1/vantage6.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)     5097 2023-05-09 13:12:26.000000 vantage6-3.8.7rc1/vantage6.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      741 2023-05-09 13:12:26.000000 vantage6-3.8.7rc1/vantage6.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-05-09 13:12:26.000000 vantage6-3.8.7rc1/vantage6.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)       94 2023-05-09 13:12:26.000000 vantage6-3.8.7rc1/vantage6.egg-info/entry_points.txt
--rw-r--r--   0 runner    (1001) docker     (123)      189 2023-05-09 13:12:26.000000 vantage6-3.8.7rc1/vantage6.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)       19 2023-05-09 13:12:26.000000 vantage6-3.8.7rc1/vantage6.egg-info/top_level.txt
...
### Comparing `vantage6-3.8.7rc1/PKG-INFO` & `vantage6-3.9.0rc2/PKG-INFO`
...
```diff
@@ -1,8 +1,8 @@
-Metadata-Version: 2.1 Name: vantage6 Version: 3.8.7rc1 Summary: vantage6
...
### Comparing `vantage6-3.8.7rc1/setup.py` & `vantage6-3.9.0rc2/setup.py`

 * *Files identical despite different names*

### Comparing `vantage6-3.8.7rc1/tests_cli/test_node_cli.py` & `vantage6-3.9.0rc2/tests_cli/test_node_cli.py`
...
### Comparing `vantage6-3.8.7rc1/tests_cli/test_server_cli.py` & `vantage6-3.9.0rc2/tests_cli/test_server_cli.py`
...
### Comparing `vantage6-3.8.7rc1/tests_cli/test_wizard.py` & `vantage6-3.9.0rc2/tests_cli/test_wizard.py`
...
### Comparing `vantage6-3.8.7rc1/vantage6/cli/_version.py` & `vantage6-3.9.0rc2/vantage6/cli/_version.py`
...
### Comparing `vantage6-3.8.7rc1/vantage6/cli/configuration_wizard.py` & `vantage6-3.9.0rc2/vantage6/cli/configuration_wizard.py`
...
### Comparing `vantage6-3.8.7rc1/vantage6/cli/context.py` & `vantage6-3.9.0rc2/vantage6/cli/context.py`
...
### Comparing `vantage6-3.8.7rc1/vantage6/cli/globals.py` & `vantage6-3.9.0rc2/vantage6/cli/globals.py`

 * *Files identical despite different names*

### Comparing `vantage6-3.8.7rc1/vantage6/cli/node.py` & `vantage6-3.9.0rc2/vantage6/cli/node.py`
...
### Comparing `vantage6-3.8.7rc1/vantage6/cli/rabbitmq/__init__.py` & `vantage6-3.9.0rc2/vantage6/cli/rabbitmq/__init__.py`
...
### Comparing `vantage6-3.8.7rc1/vantage6/cli/rabbitmq/definitions.py` & `vantage6-3.9.0rc2/vantage6/cli/rabbitmq/definitions.py`

 * *Files identical despite different names*

### Comparing `vantage6-3.8.7rc1/vantage6/cli/rabbitmq/queue_manager.py` & `vantage6-3.9.0rc2/vantage6/cli/rabbitmq/queue_manager.py`
...
### Comparing `vantage6-3.8.7rc1/vantage6/cli/server.py` & `vantage6-3.9.0rc2/vantage6/cli/server.py`
...
### Comparing `vantage6-3.8.7rc1/vantage6/cli/utils.py` & `vantage6-3.9.0rc2/vantage6/cli/utils.py`
...
### Comparing `vantage6-3.8.7rc1/vantage6.egg-info/PKG-INFO` & `vantage6-3.9.0rc2/vantage6.egg-info/PKG-INFO`
...
### Comparing `vantage6-3.8.7rc1/vantage6.egg-info/SOURCES.txt` & `vantage6-3.9.0rc2/vantage6.egg-info/SOURCES.txt`
