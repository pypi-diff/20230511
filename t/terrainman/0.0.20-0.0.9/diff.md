# Comparing `tmp/terrainman-0.0.20.tar.gz` & `tmp/terrainman-0.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "terrainman-0.0.20.tar", max compression
+gzip compressed data, was "terrainman-0.0.9.tar", max compression
```

## Comparing `terrainman-0.0.20.tar` & `terrainman-0.0.9.tar`

### file list

```diff
@@ -1,6 +1,6 @@
--rw-r--r--   0        0        0     1070 2023-05-10 17:44:29.464943 terrainman-0.0.20/LICENSE
--rw-r--r--   0        0        0        4 2023-05-10 17:38:08.409616 terrainman-0.0.20/README.md
--rw-r--r--   0        0        0     1001 2023-05-11 15:46:29.793379 terrainman-0.0.20/pyproject.toml
--rw-r--r--   0        0        0     1209 2023-05-10 19:00:34.226678 terrainman-0.0.20/src/terrainman/__init__.py
--rw-r--r--   0        0        0    10055 2023-05-10 23:47:45.751553 terrainman-0.0.20/src/terrainman/tile_io.py
--rw-r--r--   0        0        0     1103 1970-01-01 00:00:00.000000 terrainman-0.0.20/PKG-INFO
...
### Comparing `terrainman-0.0.20/LICENSE` & `terrainman-0.0.9/LICENSE`

 * *Files identical despite different names*

### Comparing `terrainman-0.0.20/pyproject.toml` & `terrainman-0.0.9/pyproject.toml`
...
### Comparing `terrainman-0.0.20/src/terrainman/tile_io.py` & `terrainman-0.0.9/src/tile_io.py`
