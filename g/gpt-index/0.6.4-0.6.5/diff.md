# Comparing `tmp/gpt_index-0.6.4.tar.gz` & `tmp/gpt_index-0.6.5.tar.gz`
...
### Comparing `gpt_index-0.6.4/LICENSE` & `gpt_index-0.6.5/LICENSE`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/PKG-INFO` & `gpt_index-0.6.5/PKG-INFO`
...
### Comparing `gpt_index-0.6.4/README.md` & `gpt_index-0.6.5/README.md`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/gpt_index.egg-info/PKG-INFO` & `gpt_index-0.6.5/gpt_index.egg-info/PKG-INFO`
...
### Comparing `gpt_index-0.6.4/gpt_index.egg-info/SOURCES.txt` & `gpt_index-0.6.5/gpt_index.egg-info/SOURCES.txt`
...
### Comparing `gpt_index-0.6.4/llama_index/__init__.py` & `gpt_index-0.6.5/llama_index/__init__.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/callbacks/base.py` & `gpt_index-0.6.5/llama_index/callbacks/base.py`
...
### Comparing `gpt_index-0.6.4/llama_index/callbacks/llama_debug.py` & `gpt_index-0.6.5/llama_index/callbacks/llama_debug.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/composability/joint_qa_summary.py` & `gpt_index-0.6.5/llama_index/composability/joint_qa_summary.py`
...
### Comparing `gpt_index-0.6.4/llama_index/data_structs/data_structs.py` & `gpt_index-0.6.5/llama_index/data_structs/data_structs.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/data_structs/document_summary.py` & `gpt_index-0.6.5/llama_index/data_structs/document_summary.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/data_structs/node.py` & `gpt_index-0.6.5/llama_index/data_structs/node.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/data_structs/registry.py` & `gpt_index-0.6.5/llama_index/data_structs/registry.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/data_structs/struct_type.py` & `gpt_index-0.6.5/llama_index/data_structs/struct_type.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/data_structs/table.py` & `gpt_index-0.6.5/llama_index/data_structs/table.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/embeddings/base.py` & `gpt_index-0.6.5/llama_index/embeddings/base.py`
...
### Comparing `gpt_index-0.6.4/llama_index/embeddings/google.py` & `gpt_index-0.6.5/llama_index/embeddings/google.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/embeddings/langchain.py` & `gpt_index-0.6.5/llama_index/embeddings/langchain.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/embeddings/openai.py` & `gpt_index-0.6.5/llama_index/embeddings/openai.py`
...
### Comparing `gpt_index-0.6.4/llama_index/embeddings/utils.py` & `gpt_index-0.6.5/llama_index/embeddings/utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/evaluation/base.py` & `gpt_index-0.6.5/llama_index/evaluation/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/evaluation/dataset_generation.py` & `gpt_index-0.6.5/llama_index/evaluation/dataset_generation.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/img_utils.py` & `gpt_index-0.6.5/llama_index/img_utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/__init__.py` & `gpt_index-0.6.5/llama_index/indices/__init__.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/base.py` & `gpt_index-0.6.5/llama_index/indices/base.py`
...
### Comparing `gpt_index-0.6.4/llama_index/indices/base_retriever.py` & `gpt_index-0.6.5/llama_index/indices/base_retriever.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/common/struct_store/base.py` & `gpt_index-0.6.5/llama_index/indices/common/struct_store/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/common/struct_store/schema.py` & `gpt_index-0.6.5/llama_index/indices/common/struct_store/schema.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/common/struct_store/sql.py` & `gpt_index-0.6.5/llama_index/indices/common/struct_store/sql.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/common_tree/base.py` & `gpt_index-0.6.5/llama_index/indices/common_tree/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/composability/graph.py` & `gpt_index-0.6.5/llama_index/indices/composability/graph.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/document_summary/base.py` & `gpt_index-0.6.5/llama_index/indices/document_summary/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/document_summary/retrievers.py` & `gpt_index-0.6.5/llama_index/indices/document_summary/retrievers.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/empty/base.py` & `gpt_index-0.6.5/llama_index/indices/empty/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/empty/retrievers.py` & `gpt_index-0.6.5/llama_index/indices/empty/retrievers.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/keyword_table/__init__.py` & `gpt_index-0.6.5/llama_index/indices/keyword_table/__init__.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/keyword_table/base.py` & `gpt_index-0.6.5/llama_index/indices/keyword_table/base.py`
...
### Comparing `gpt_index-0.6.4/llama_index/indices/keyword_table/rake_base.py` & `gpt_index-0.6.5/llama_index/indices/keyword_table/rake_base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/keyword_table/retrievers.py` & `gpt_index-0.6.5/llama_index/indices/keyword_table/retrievers.py`
...
### Comparing `gpt_index-0.6.4/llama_index/indices/keyword_table/simple_base.py` & `gpt_index-0.6.5/llama_index/indices/keyword_table/simple_base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/keyword_table/utils.py` & `gpt_index-0.6.5/llama_index/indices/keyword_table/utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/knowledge_graph/base.py` & `gpt_index-0.6.5/llama_index/indices/knowledge_graph/base.py`
...
### Comparing `gpt_index-0.6.4/llama_index/indices/knowledge_graph/retrievers.py` & `gpt_index-0.6.5/llama_index/indices/knowledge_graph/retrievers.py`
...
### Comparing `gpt_index-0.6.4/llama_index/indices/list/base.py` & `gpt_index-0.6.5/llama_index/indices/list/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/list/retrievers.py` & `gpt_index-0.6.5/llama_index/indices/list/retrievers.py`
...
### Comparing `gpt_index-0.6.4/llama_index/indices/loading.py` & `gpt_index-0.6.5/llama_index/indices/loading.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/postprocessor/__init__.py` & `gpt_index-0.6.5/llama_index/indices/postprocessor/__init__.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/postprocessor/cohere_rerank.py` & `gpt_index-0.6.5/llama_index/indices/postprocessor/cohere_rerank.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/postprocessor/node.py` & `gpt_index-0.6.5/llama_index/indices/postprocessor/node.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/postprocessor/node_recency.py` & `gpt_index-0.6.5/llama_index/indices/postprocessor/node_recency.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/postprocessor/pii.py` & `gpt_index-0.6.5/llama_index/indices/postprocessor/pii.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/prompt_helper.py` & `gpt_index-0.6.5/llama_index/indices/prompt_helper.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/query/base.py` & `gpt_index-0.6.5/llama_index/indices/query/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/query/embedding_utils.py` & `gpt_index-0.6.5/llama_index/indices/query/embedding_utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/query/query_transform/base.py` & `gpt_index-0.6.5/llama_index/indices/query/query_transform/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/query/query_transform/prompts.py` & `gpt_index-0.6.5/llama_index/indices/query/query_transform/prompts.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/query/response_synthesis.py` & `gpt_index-0.6.5/llama_index/indices/query/response_synthesis.py`
...
### Comparing `gpt_index-0.6.4/llama_index/indices/query/schema.py` & `gpt_index-0.6.5/llama_index/indices/query/schema.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/registry.py` & `gpt_index-0.6.5/llama_index/indices/registry.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/response/response_builder.py` & `gpt_index-0.6.5/llama_index/indices/response/response_builder.py`
...
### Comparing `gpt_index-0.6.4/llama_index/indices/service_context.py` & `gpt_index-0.6.5/llama_index/indices/service_context.py`
...
### Comparing `gpt_index-0.6.4/llama_index/indices/struct_store/__init__.py` & `gpt_index-0.6.5/llama_index/indices/struct_store/__init__.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/struct_store/base.py` & `gpt_index-0.6.5/llama_index/indices/struct_store/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/struct_store/container_builder.py` & `gpt_index-0.6.5/llama_index/indices/struct_store/container_builder.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/struct_store/pandas.py` & `gpt_index-0.6.5/llama_index/indices/struct_store/pandas.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/struct_store/pandas_query.py` & `gpt_index-0.6.5/llama_index/indices/struct_store/pandas_query.py`
...
### Comparing `gpt_index-0.6.4/llama_index/indices/struct_store/sql.py` & `gpt_index-0.6.5/llama_index/indices/struct_store/sql.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/struct_store/sql_query.py` & `gpt_index-0.6.5/llama_index/indices/struct_store/sql_query.py`
...
### Comparing `gpt_index-0.6.4/llama_index/indices/tree/__init__.py` & `gpt_index-0.6.5/llama_index/indices/tree/__init__.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/tree/all_leaf_retriever.py` & `gpt_index-0.6.5/llama_index/indices/tree/all_leaf_retriever.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/tree/base.py` & `gpt_index-0.6.5/llama_index/indices/tree/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/tree/inserter.py` & `gpt_index-0.6.5/llama_index/indices/tree/inserter.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/tree/select_leaf_embedding_retriever.py` & `gpt_index-0.6.5/llama_index/indices/tree/select_leaf_embedding_retriever.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/tree/select_leaf_retriever.py` & `gpt_index-0.6.5/llama_index/indices/tree/select_leaf_retriever.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/tree/tree_root_retriever.py` & `gpt_index-0.6.5/llama_index/indices/tree/tree_root_retriever.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/utils.py` & `gpt_index-0.6.5/llama_index/indices/utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/indices/vector_store/base.py` & `gpt_index-0.6.5/llama_index/indices/vector_store/base.py`
...
### Comparing `gpt_index-0.6.4/llama_index/indices/vector_store/retrievers.py` & `gpt_index-0.6.5/llama_index/indices/vector_store/retrievers.py`
...
### Comparing `gpt_index-0.6.4/llama_index/langchain_helpers/agents/__init__.py` & `gpt_index-0.6.5/llama_index/langchain_helpers/agents/__init__.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/langchain_helpers/agents/agents.py` & `gpt_index-0.6.5/llama_index/langchain_helpers/agents/agents.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/langchain_helpers/agents/toolkits.py` & `gpt_index-0.6.5/llama_index/langchain_helpers/agents/toolkits.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/langchain_helpers/agents/tools.py` & `gpt_index-0.6.5/llama_index/langchain_helpers/agents/tools.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/langchain_helpers/memory_wrapper.py` & `gpt_index-0.6.5/llama_index/langchain_helpers/memory_wrapper.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/langchain_helpers/sql_wrapper.py` & `gpt_index-0.6.5/llama_index/langchain_helpers/sql_wrapper.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/langchain_helpers/text_splitter.py` & `gpt_index-0.6.5/llama_index/langchain_helpers/text_splitter.py`
...
### Comparing `gpt_index-0.6.4/llama_index/llm_predictor/base.py` & `gpt_index-0.6.5/llama_index/llm_predictor/base.py`
...
### Comparing `gpt_index-0.6.4/llama_index/llm_predictor/chatgpt.py` & `gpt_index-0.6.5/llama_index/llm_predictor/chatgpt.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/llm_predictor/huggingface.py` & `gpt_index-0.6.5/llama_index/llm_predictor/huggingface.py`
...
### Comparing `gpt_index-0.6.4/llama_index/llm_predictor/structured.py` & `gpt_index-0.6.5/llama_index/llm_predictor/structured.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/logger/base.py` & `gpt_index-0.6.5/llama_index/logger/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/node_parser/interface.py` & `gpt_index-0.6.5/llama_index/node_parser/interface.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/node_parser/node_utils.py` & `gpt_index-0.6.5/llama_index/node_parser/node_utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/node_parser/simple.py` & `gpt_index-0.6.5/llama_index/node_parser/simple.py`
...
### Comparing `gpt_index-0.6.4/llama_index/optimization/optimizer.py` & `gpt_index-0.6.5/llama_index/optimization/optimizer.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/output_parsers/base.py` & `gpt_index-0.6.5/llama_index/output_parsers/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/output_parsers/guardrails.py` & `gpt_index-0.6.5/llama_index/output_parsers/guardrails.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/output_parsers/langchain.py` & `gpt_index-0.6.5/llama_index/output_parsers/langchain.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/output_parsers/selection.py` & `gpt_index-0.6.5/llama_index/output_parsers/selection.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/playground/base.py` & `gpt_index-0.6.5/llama_index/playground/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/prompts/base.py` & `gpt_index-0.6.5/llama_index/prompts/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/prompts/chat_prompts.py` & `gpt_index-0.6.5/llama_index/prompts/chat_prompts.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/prompts/default_prompt_selectors.py` & `gpt_index-0.6.5/llama_index/prompts/default_prompt_selectors.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/prompts/default_prompts.py` & `gpt_index-0.6.5/llama_index/prompts/default_prompts.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/prompts/prompt_type.py` & `gpt_index-0.6.5/llama_index/prompts/prompt_type.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/prompts/prompts.py` & `gpt_index-0.6.5/llama_index/prompts/prompts.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/query_engine/__init__.py` & `gpt_index-0.6.5/llama_index/query_engine/__init__.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/query_engine/graph_query_engine.py` & `gpt_index-0.6.5/llama_index/query_engine/graph_query_engine.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/query_engine/multistep_query_engine.py` & `gpt_index-0.6.5/llama_index/query_engine/multistep_query_engine.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/query_engine/retriever_query_engine.py` & `gpt_index-0.6.5/llama_index/query_engine/retriever_query_engine.py`
...
### Comparing `gpt_index-0.6.4/llama_index/query_engine/router_query_engine.py` & `gpt_index-0.6.5/llama_index/query_engine/router_query_engine.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/query_engine/transform_query_engine.py` & `gpt_index-0.6.5/llama_index/query_engine/transform_query_engine.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/__init__.py` & `gpt_index-0.6.5/llama_index/readers/__init__.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/base.py` & `gpt_index-0.6.5/llama_index/readers/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/chatgpt_plugin/base.py` & `gpt_index-0.6.5/llama_index/readers/chatgpt_plugin/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/chroma.py` & `gpt_index-0.6.5/llama_index/readers/chroma.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/database.py` & `gpt_index-0.6.5/llama_index/readers/database.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/deeplake.py` & `gpt_index-0.6.5/llama_index/readers/deeplake.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/discord_reader.py` & `gpt_index-0.6.5/llama_index/readers/discord_reader.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/download.py` & `gpt_index-0.6.5/llama_index/readers/download.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/elasticsearch.py` & `gpt_index-0.6.5/llama_index/readers/elasticsearch.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/faiss.py` & `gpt_index-0.6.5/llama_index/readers/faiss.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/file/base.py` & `gpt_index-0.6.5/llama_index/readers/file/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/file/base_parser.py` & `gpt_index-0.6.5/llama_index/readers/file/base_parser.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/file/docs_parser.py` & `gpt_index-0.6.5/llama_index/readers/file/docs_parser.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/file/epub_parser.py` & `gpt_index-0.6.5/llama_index/readers/file/epub_parser.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/file/image_caption_parser.py` & `gpt_index-0.6.5/llama_index/readers/file/image_caption_parser.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/file/image_parser.py` & `gpt_index-0.6.5/llama_index/readers/file/image_parser.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/file/image_vision_llm_parser.py` & `gpt_index-0.6.5/llama_index/readers/file/image_vision_llm_parser.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/file/ipynb_parser.py` & `gpt_index-0.6.5/llama_index/readers/file/ipynb_parser.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/file/markdown_parser.py` & `gpt_index-0.6.5/llama_index/readers/file/markdown_parser.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/file/mbox_parser.py` & `gpt_index-0.6.5/llama_index/readers/file/mbox_parser.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/file/slides_parser.py` & `gpt_index-0.6.5/llama_index/readers/file/slides_parser.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/file/tabular_parser.py` & `gpt_index-0.6.5/llama_index/readers/file/tabular_parser.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/file/video_audio.py` & `gpt_index-0.6.5/llama_index/readers/file/video_audio.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/github_readers/github_api_client.py` & `gpt_index-0.6.5/llama_index/readers/github_readers/github_api_client.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/github_readers/github_repository_reader.py` & `gpt_index-0.6.5/llama_index/readers/github_readers/github_repository_reader.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/github_readers/utils.py` & `gpt_index-0.6.5/llama_index/readers/github_readers/utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/google_readers/gdocs.py` & `gpt_index-0.6.5/llama_index/readers/google_readers/gdocs.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/google_readers/gsheets.py` & `gpt_index-0.6.5/llama_index/readers/google_readers/gsheets.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/json.py` & `gpt_index-0.6.5/llama_index/readers/json.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/make_com/wrapper.py` & `gpt_index-0.6.5/llama_index/readers/make_com/wrapper.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/mbox.py` & `gpt_index-0.6.5/llama_index/readers/mbox.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/metal.py` & `gpt_index-0.6.5/llama_index/readers/metal.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/milvus.py` & `gpt_index-0.6.5/llama_index/readers/milvus.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/mongo.py` & `gpt_index-0.6.5/llama_index/readers/mongo.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/myscale.py` & `gpt_index-0.6.5/llama_index/readers/myscale.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/notion.py` & `gpt_index-0.6.5/llama_index/readers/notion.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/obsidian.py` & `gpt_index-0.6.5/llama_index/readers/obsidian.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/pinecone.py` & `gpt_index-0.6.5/llama_index/readers/pinecone.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/qdrant.py` & `gpt_index-0.6.5/llama_index/readers/qdrant.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/schema/base.py` & `gpt_index-0.6.5/llama_index/readers/schema/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/slack.py` & `gpt_index-0.6.5/llama_index/readers/slack.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/steamship/file_reader.py` & `gpt_index-0.6.5/llama_index/readers/steamship/file_reader.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/string_iterable.py` & `gpt_index-0.6.5/llama_index/readers/string_iterable.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/twitter.py` & `gpt_index-0.6.5/llama_index/readers/twitter.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/weaviate/client.py` & `gpt_index-0.6.5/llama_index/readers/weaviate/client.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/weaviate/reader.py` & `gpt_index-0.6.5/llama_index/readers/weaviate/reader.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/weaviate/utils.py` & `gpt_index-0.6.5/llama_index/readers/weaviate/utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/web.py` & `gpt_index-0.6.5/llama_index/readers/web.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/wikipedia.py` & `gpt_index-0.6.5/llama_index/readers/wikipedia.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/readers/youtube_transcript.py` & `gpt_index-0.6.5/llama_index/readers/youtube_transcript.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/response/notebook_utils.py` & `gpt_index-0.6.5/llama_index/response/notebook_utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/response/pprint_utils.py` & `gpt_index-0.6.5/llama_index/response/pprint_utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/response/schema.py` & `gpt_index-0.6.5/llama_index/response/schema.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/retrievers/__init__.py` & `gpt_index-0.6.5/llama_index/retrievers/__init__.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/retrievers/transform_retriever.py` & `gpt_index-0.6.5/llama_index/retrievers/transform_retriever.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/schema.py` & `gpt_index-0.6.5/llama_index/schema.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/selectors/llm_selectors.py` & `gpt_index-0.6.5/llama_index/selectors/llm_selectors.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/selectors/prompts.py` & `gpt_index-0.6.5/llama_index/selectors/prompts.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/selectors/types.py` & `gpt_index-0.6.5/llama_index/selectors/types.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/storage/docstore/__init__.py` & `gpt_index-0.6.5/llama_index/storage/docstore/__init__.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/storage/docstore/keyval_docstore.py` & `gpt_index-0.6.5/llama_index/storage/docstore/keyval_docstore.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/storage/docstore/mongo_docstore.py` & `gpt_index-0.6.5/llama_index/storage/docstore/mongo_docstore.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/storage/docstore/registry.py` & `gpt_index-0.6.5/llama_index/storage/docstore/registry.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/storage/docstore/simple_docstore.py` & `gpt_index-0.6.5/llama_index/storage/docstore/simple_docstore.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/storage/docstore/types.py` & `gpt_index-0.6.5/llama_index/storage/docstore/types.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/storage/docstore/utils.py` & `gpt_index-0.6.5/llama_index/storage/docstore/utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/storage/index_store/keyval_index_store.py` & `gpt_index-0.6.5/llama_index/storage/index_store/keyval_index_store.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/storage/index_store/mongo_index_store.py` & `gpt_index-0.6.5/llama_index/storage/index_store/mongo_index_store.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/storage/index_store/simple_index_store.py` & `gpt_index-0.6.5/llama_index/storage/index_store/simple_index_store.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/storage/index_store/types.py` & `gpt_index-0.6.5/llama_index/storage/index_store/types.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/storage/index_store/utils.py` & `gpt_index-0.6.5/llama_index/storage/index_store/utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/storage/kvstore/mongodb_kvstore.py` & `gpt_index-0.6.5/llama_index/storage/kvstore/mongodb_kvstore.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/storage/kvstore/simple_kvstore.py` & `gpt_index-0.6.5/llama_index/storage/kvstore/simple_kvstore.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/storage/kvstore/types.py` & `gpt_index-0.6.5/llama_index/storage/kvstore/types.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/storage/storage_context.py` & `gpt_index-0.6.5/llama_index/storage/storage_context.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/token_counter/mock_chain_wrapper.py` & `gpt_index-0.6.5/llama_index/token_counter/mock_chain_wrapper.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/token_counter/mock_embed_model.py` & `gpt_index-0.6.5/llama_index/token_counter/mock_embed_model.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/token_counter/token_counter.py` & `gpt_index-0.6.5/llama_index/token_counter/token_counter.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/token_counter/utils.py` & `gpt_index-0.6.5/llama_index/token_counter/utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/tools/query_engine.py` & `gpt_index-0.6.5/llama_index/tools/query_engine.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/tts/bark.py` & `gpt_index-0.6.5/llama_index/tts/bark.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/tts/base.py` & `gpt_index-0.6.5/llama_index/tts/base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/tts/elevenlabs.py` & `gpt_index-0.6.5/llama_index/tts/elevenlabs.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/utils.py` & `gpt_index-0.6.5/llama_index/utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/vector_stores/__init__.py` & `gpt_index-0.6.5/llama_index/vector_stores/__init__.py`
...
### Comparing `gpt_index-0.6.4/llama_index/vector_stores/chatgpt_plugin.py` & `gpt_index-0.6.5/llama_index/vector_stores/chatgpt_plugin.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/vector_stores/chroma.py` & `gpt_index-0.6.5/llama_index/vector_stores/chroma.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/vector_stores/deeplake.py` & `gpt_index-0.6.5/llama_index/vector_stores/deeplake.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/vector_stores/faiss.py` & `gpt_index-0.6.5/llama_index/vector_stores/faiss.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/vector_stores/lancedb.py` & `gpt_index-0.6.5/llama_index/vector_stores/lancedb.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/vector_stores/metal.py` & `gpt_index-0.6.5/llama_index/vector_stores/metal.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/vector_stores/milvus.py` & `gpt_index-0.6.5/llama_index/vector_stores/milvus.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/vector_stores/myscale.py` & `gpt_index-0.6.5/llama_index/vector_stores/myscale.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/vector_stores/opensearch.py` & `gpt_index-0.6.5/llama_index/vector_stores/opensearch.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/vector_stores/pinecone.py` & `gpt_index-0.6.5/llama_index/vector_stores/pinecone.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/vector_stores/qdrant.py` & `gpt_index-0.6.5/llama_index/vector_stores/qdrant.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/vector_stores/registry.py` & `gpt_index-0.6.5/llama_index/vector_stores/registry.py`
...
### Comparing `gpt_index-0.6.4/llama_index/vector_stores/simple.py` & `gpt_index-0.6.5/llama_index/vector_stores/simple.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/vector_stores/types.py` & `gpt_index-0.6.5/llama_index/vector_stores/types.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/llama_index/vector_stores/weaviate.py` & `gpt_index-0.6.5/llama_index/vector_stores/weaviate.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/setup.py` & `gpt_index-0.6.5/setup.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/callbacks/test_llama_debug.py` & `gpt_index-0.6.5/tests/callbacks/test_llama_debug.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/conftest.py` & `gpt_index-0.6.5/tests/conftest.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/embeddings/test_base.py` & `gpt_index-0.6.5/tests/embeddings/test_base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/composability/test_utils.py` & `gpt_index-0.6.5/tests/indices/composability/test_utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/conftest.py` & `gpt_index-0.6.5/tests/indices/conftest.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/document_summary/test_index.py` & `gpt_index-0.6.5/tests/indices/document_summary/test_index.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/empty/test_base.py` & `gpt_index-0.6.5/tests/indices/empty/test_base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/keyword_table/test_base.py` & `gpt_index-0.6.5/tests/indices/keyword_table/test_base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/keyword_table/test_retrievers.py` & `gpt_index-0.6.5/tests/indices/keyword_table/test_retrievers.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/keyword_table/test_utils.py` & `gpt_index-0.6.5/tests/indices/keyword_table/test_utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/knowledge_graph/test_base.py` & `gpt_index-0.6.5/tests/indices/knowledge_graph/test_base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/knowledge_graph/test_retrievers.py` & `gpt_index-0.6.5/tests/indices/knowledge_graph/test_retrievers.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/list/test_index.py` & `gpt_index-0.6.5/tests/indices/list/test_index.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/list/test_retrievers.py` & `gpt_index-0.6.5/tests/indices/list/test_retrievers.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/postprocessor/test_base.py` & `gpt_index-0.6.5/tests/indices/postprocessor/test_base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/query/conftest.py` & `gpt_index-0.6.5/tests/indices/query/conftest.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/query/query_transform/test_base.py` & `gpt_index-0.6.5/tests/indices/query/query_transform/test_base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/query/test_compose.py` & `gpt_index-0.6.5/tests/indices/query/test_compose.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/query/test_compose_vector.py` & `gpt_index-0.6.5/tests/indices/query/test_compose_vector.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/query/test_query_bundle.py` & `gpt_index-0.6.5/tests/indices/query/test_query_bundle.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/struct_store/conftest.py` & `gpt_index-0.6.5/tests/indices/struct_store/conftest.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/struct_store/test_base.py` & `gpt_index-0.6.5/tests/indices/struct_store/test_base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/struct_store/test_pandas.py` & `gpt_index-0.6.5/tests/indices/struct_store/test_pandas.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/struct_store/test_sql_query.py` & `gpt_index-0.6.5/tests/indices/struct_store/test_sql_query.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/test_loading.py` & `gpt_index-0.6.5/tests/indices/test_loading.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/test_loading_graph.py` & `gpt_index-0.6.5/tests/indices/test_loading_graph.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/test_node_utils.py` & `gpt_index-0.6.5/tests/indices/test_node_utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/test_prompt_helper.py` & `gpt_index-0.6.5/tests/indices/test_prompt_helper.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/tree/conftest.py` & `gpt_index-0.6.5/tests/indices/tree/conftest.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/tree/test_embedding_retriever.py` & `gpt_index-0.6.5/tests/indices/tree/test_embedding_retriever.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/tree/test_index.py` & `gpt_index-0.6.5/tests/indices/tree/test_index.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/tree/test_retrievers.py` & `gpt_index-0.6.5/tests/indices/tree/test_retrievers.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/vector_store/conftest.py` & `gpt_index-0.6.5/tests/indices/vector_store/conftest.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/vector_store/mock_faiss.py` & `gpt_index-0.6.5/tests/indices/vector_store/mock_faiss.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/vector_store/mock_services.py` & `gpt_index-0.6.5/tests/indices/vector_store/mock_services.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/vector_store/test_faiss.py` & `gpt_index-0.6.5/tests/indices/vector_store/test_faiss.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/vector_store/test_lancedb.py` & `gpt_index-0.6.5/tests/indices/vector_store/test_lancedb.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/vector_store/test_milvus.py` & `gpt_index-0.6.5/tests/indices/vector_store/test_milvus.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/vector_store/test_myscale.py` & `gpt_index-0.6.5/tests/indices/vector_store/test_myscale.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/vector_store/test_pinecone.py` & `gpt_index-0.6.5/tests/indices/vector_store/test_pinecone.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/vector_store/test_retrievers.py` & `gpt_index-0.6.5/tests/indices/vector_store/test_retrievers.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/vector_store/test_simple.py` & `gpt_index-0.6.5/tests/indices/vector_store/test_simple.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/vector_store/test_weaviate.py` & `gpt_index-0.6.5/tests/indices/vector_store/test_weaviate.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/indices/vector_store/utils.py` & `gpt_index-0.6.5/tests/indices/vector_store/utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/langchain_helpers/test_text_splitter.py` & `gpt_index-0.6.5/tests/langchain_helpers/test_text_splitter.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/llm_predictor/test_base.py` & `gpt_index-0.6.5/tests/llm_predictor/test_base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/logger/test_base.py` & `gpt_index-0.6.5/tests/logger/test_base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/mock_utils/mock_predict.py` & `gpt_index-0.6.5/tests/mock_utils/mock_predict.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/mock_utils/mock_prompts.py` & `gpt_index-0.6.5/tests/mock_utils/mock_prompts.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/mock_utils/mock_text_splitter.py` & `gpt_index-0.6.5/tests/mock_utils/mock_text_splitter.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/mock_utils/mock_utils.py` & `gpt_index-0.6.5/tests/mock_utils/mock_utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/optimization/test_base.py` & `gpt_index-0.6.5/tests/optimization/test_base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/output_parsers/test_base.py` & `gpt_index-0.6.5/tests/output_parsers/test_base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/output_parsers/test_selection.py` & `gpt_index-0.6.5/tests/output_parsers/test_selection.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/playground/test_base.py` & `gpt_index-0.6.5/tests/playground/test_base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/prompts/test_base.py` & `gpt_index-0.6.5/tests/prompts/test_base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/readers/test_file.py` & `gpt_index-0.6.5/tests/readers/test_file.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/readers/test_json.py` & `gpt_index-0.6.5/tests/readers/test_json.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/readers/test_mongo.py` & `gpt_index-0.6.5/tests/readers/test_mongo.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/selectors/test_llm_selectors.py` & `gpt_index-0.6.5/tests/selectors/test_llm_selectors.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/storage/conftest.py` & `gpt_index-0.6.5/tests/storage/conftest.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/storage/docstore/test_mongo_docstore.py` & `gpt_index-0.6.5/tests/storage/docstore/test_mongo_docstore.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/storage/docstore/test_simple_docstore.py` & `gpt_index-0.6.5/tests/storage/docstore/test_simple_docstore.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/storage/test_storage_context.py` & `gpt_index-0.6.5/tests/storage/test_storage_context.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/test_utils.py` & `gpt_index-0.6.5/tests/test_utils.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/token_predictor/test_base.py` & `gpt_index-0.6.5/tests/token_predictor/test_base.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/vector_stores/test_qdrant.py` & `gpt_index-0.6.5/tests/vector_stores/test_qdrant.py`

 * *Files identical despite different names*

### Comparing `gpt_index-0.6.4/tests/vector_stores/test_weaviate.py` & `gpt_index-0.6.5/tests/vector_stores/test_weaviate.py`
