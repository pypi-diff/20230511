# Comparing `tmp/disposable-email-domains-0.0.87.tar.gz` & `tmp/disposable-email-domains-0.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "disposable-email-domains-0.0.87.tar", last modified: Thu May 11 18:08:13 2023, max compression
+gzip compressed data, was "dist/disposable-email-domains-0.0.9.tar", last modified: Fri Apr 28 15:38:42 2017, max compression
```

## Comparing `disposable-email-domains-0.0.87.tar` & `disposable-email-domains-0.0.9.tar`

### file list

```diff
@@ -1,29 +1,25 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-11 18:08:13.788347 disposable-email-domains-0.0.87/
--rw-r--r--   0 runner    (1001) docker     (123)      299 2023-05-11 18:08:03.000000 disposable-email-domains-0.0.87/CONTRIBUTING.md
--rw-r--r--   0 runner    (1001) docker     (123)     1080 2023-05-11 18:08:03.000000 disposable-email-domains-0.0.87/LICENSE.txt
--rw-r--r--   0 runner    (1001) docker     (123)      134 2023-05-11 18:08:03.000000 disposable-email-domains-0.0.87/MANIFEST.in
--rw-r--r--   0 runner    (1001) docker     (123)     1592 2023-05-11 18:08:13.788347 disposable-email-domains-0.0.87/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      810 2023-05-11 18:08:03.000000 disposable-email-domains-0.0.87/README.md
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-11 18:08:13.788347 disposable-email-domains-0.0.87/bin/
--rwxr-xr-x   0 runner    (1001) docker     (123)     1171 2023-05-11 18:08:03.000000 disposable-email-domains-0.0.87/bin/check_for_differences
--rw-r--r--   0 runner    (1001) docker     (123)      568 2023-05-11 18:08:03.000000 disposable-email-domains-0.0.87/bin/parse_source_data
--rwxr-xr-x   0 runner    (1001) docker     (123)       83 2023-05-11 18:08:03.000000 disposable-email-domains-0.0.87/bin/prerelease
--rwxr-xr-x   0 runner    (1001) docker     (123)      119 2023-05-11 18:08:03.000000 disposable-email-domains-0.0.87/bin/release
--rwxr-xr-x   0 runner    (1001) docker     (123)      292 2023-05-11 18:08:03.000000 disposable-email-domains-0.0.87/bin/update
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-11 18:08:13.788347 disposable-email-domains-0.0.87/disposable_email_domains/
--rw-r--r--   0 runner    (1001) docker     (123)    73338 2023-05-11 18:08:03.000000 disposable-email-domains-0.0.87/disposable_email_domains/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-11 18:08:13.788347 disposable-email-domains-0.0.87/disposable_email_domains.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)     1592 2023-05-11 18:08:13.000000 disposable-email-domains-0.0.87/disposable_email_domains.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      567 2023-05-11 18:08:13.000000 disposable-email-domains-0.0.87/disposable_email_domains.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-05-11 18:08:13.000000 disposable-email-domains-0.0.87/disposable_email_domains.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)       22 2023-05-11 18:08:13.000000 disposable-email-domains-0.0.87/disposable_email_domains.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)       25 2023-05-11 18:08:13.000000 disposable-email-domains-0.0.87/disposable_email_domains.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (123)       67 2023-05-11 18:08:13.788347 disposable-email-domains-0.0.87/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (123)     1184 2023-05-11 18:08:03.000000 disposable-email-domains-0.0.87/setup.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-11 18:08:13.788347 disposable-email-domains-0.0.87/source_data/
--rw-r--r--   0 runner    (1001) docker     (123)     2209 2023-05-11 18:08:03.000000 disposable-email-domains-0.0.87/source_data/allowlist.conf
--rw-r--r--   0 runner    (1001) docker     (123)    45442 2023-05-11 18:08:03.000000 disposable-email-domains-0.0.87/source_data/disposable_email_blocklist.conf
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-11 18:08:13.788347 disposable-email-domains-0.0.87/tests/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-05-11 18:08:03.000000 disposable-email-domains-0.0.87/tests/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)      201 2023-05-11 18:08:03.000000 disposable-email-domains-0.0.87/tests/test_allowlist.py
--rw-r--r--   0 runner    (1001) docker     (123)      201 2023-05-11 18:08:03.000000 disposable-email-domains-0.0.87/tests/test_blocklist.py
...
### Comparing `disposable-email-domains-0.0.87/LICENSE.txt` & `disposable-email-domains-0.0.9/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `disposable-email-domains-0.0.87/PKG-INFO` & `disposable-email-domains-0.0.9/disposable_email_domains.egg-info/PKG-INFO`
...
### Comparing `disposable-email-domains-0.0.87/README.md` & `disposable-email-domains-0.0.9/README.rst`
...
### Comparing `disposable-email-domains-0.0.87/disposable_email_domains/__init__.py` & `disposable-email-domains-0.0.9/disposable_email_domains/__init__.py`
...
### Comparing `disposable-email-domains-0.0.87/disposable_email_domains.egg-info/PKG-INFO` & `disposable-email-domains-0.0.9/PKG-INFO`
...
### Comparing `disposable-email-domains-0.0.87/setup.py` & `disposable-email-domains-0.0.9/setup.py`
...
### Comparing `disposable-email-domains-0.0.87/source_data/allowlist.conf` & `disposable-email-domains-0.0.9/source_data/whitelist.conf`
